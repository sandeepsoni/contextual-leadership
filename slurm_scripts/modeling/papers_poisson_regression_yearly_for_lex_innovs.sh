...
python papers_poisson_regression_yearly.py --paper-ids-file $SCRATCH_DIR/data/raw/s2orc_acl.p4.jsonl --input-file $SCRATCH_DIR/data/cascades/paper.counts.jsonl --coefficients-file $SCRATCH_DIR/data/experiments/004/paper_coefficients/$REG_FILE$YEAR.tsv --regularization $REG --history-window $HIST_WINDOW --year $YEAR
conda deactivate
#source deactivate
