...
cd $PROJECTS_DIR/scripts/pre-measurement-word-filters
module load cuda/10.2
hostname
which python

python by_document_coverage.py --input-embeddings-file $SCRATCH_DIR/data/contextual-embeddings/s2orc_acl_embeddings.tsv --min-df-fraction 0.9 --keep-file $SCRATCH_DIR/data/pre-measurement-filters/by_document_coverage.keep --discard-file $SCRATCH_DIR/data/pre-measurement-filters/by_document_coverage.discard 
