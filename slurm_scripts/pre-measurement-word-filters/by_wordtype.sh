...
python by_wordtype.py --input-embeddings-file $SCRATCH_DIR/data/contextual-embeddings/s2orc_acl_embeddings.tsv --keep-file $SCRATCH_DIR/data/pre-measurement-filters/by_wordtype.keep --discard-file $SCRATCH_DIR/data/pre-measurement-filters/by_wordtype.discard 
