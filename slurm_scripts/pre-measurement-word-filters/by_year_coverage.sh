...
python by_year_coverage.py --input-embeddings-file $SCRATCH_DIR/data/contextual-embeddings/s2orc_acl_embeddings.tsv --min-year-fraction 0.25 --keep-file $SCRATCH_DIR/data/pre-measurement-filters/by_year_coverage.keep --discard-file $SCRATCH_DIR/data/pre-measurement-filters/by_year_coverage.discard 
