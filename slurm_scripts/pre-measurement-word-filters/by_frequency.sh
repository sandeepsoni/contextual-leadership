...
python by_frequency.py --input-embeddings-file $SCRATCH_DIR/data/contextual-embeddings/s2orc_acl_embeddings.tsv --min-freq 30 --keep-file $SCRATCH_DIR/data/pre-measurement-filters/by_frequency.keep --discard-file $SCRATCH_DIR/data/pre-measurement-filters/by_frequency.discard 
