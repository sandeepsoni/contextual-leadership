...
python measure_change.py --words-file $SCRATCH_DIR/data/pre-measurement-filters/by_overall_filters$SUFFIX.keepparts --word-embeddings-dir $SCRATCH_DIR/data/aggregator
