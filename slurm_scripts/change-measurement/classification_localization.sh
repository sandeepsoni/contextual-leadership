...
cd $PROJECTS_DIR/scripts/change-measurement
module load cuda/10.2
hostname
which python

python classification_localization.py --groundtruth-file $SCRATCH_DIR/data/overall-stats/changepoints.frequency_accounting.tsv --words-file $SCRATCH_DIR/data/pre-measurement-filters/by_overall_filters$SUFFIX.keepparts --word-embeddings-dir $SCRATCH_DIR/data/aggregator/ --from-index $FROM_INDEX --till-index $TILL_INDEX
