...
def main (args):
	...
	all_files = [filename for filename in glob.glob (os.path.join (args.dirname, "*.keep")) if not filename == os.path.join (args.dirname, "by_overall_filters.keep")]
	all_files.extend ([filename for filename in glob.glob (os.path.join (args.dirname, "*.discard")) if not filename == os.path.join (args.dirname, "by_overall_filters.discard")])
